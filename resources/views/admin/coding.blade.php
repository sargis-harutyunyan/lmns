    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Coding Page</h6>
            </div>
            <div class="card-body">


                <form method="POST" action="{{ route('pages.coding.top') }}">
                    @csrf
                ...
                <form method="POST" action="{{ route('pages.coding.middle') }}">
                    @csrf
                    <div style="margin-top: 25px" class="col-md-12">
                        <h3>Middle</h3>
                        <div class="row">
                ...
                <form method="POST" action="{{ route('pages.coding.middle-1') }}">
                    @csrf
                    <div style="margin-top: 25px" class="col-md-12">
                ...
                <form method="POST" action="{{ route('pages.coding.middle-2') }}">
                    @csrf
                    <div style="margin-top: 25px" class="col-md-12">
                ...
                <form method="POST" action="{{ route('pages.coding.middle-3') }}">
                    @csrf
                    <div style="margin-top: 25px" class="col-md-12">
                ...
                <form method="POST" action="{{ route('pages.coding.bottom') }}">
                    @csrf
                    <div style="margin-top: 25px" class="col-md-12">
                        <h3>Bottom</h3>
                        <div class="row">
